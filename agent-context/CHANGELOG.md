...
| 2026-09-12 | PORTAL-103 | Feature | Customer Support Tier and Escalation SLA fields on Account | `force-app/main/default/objects/Account/*`, `/agent-context/*` | Pending PR |
